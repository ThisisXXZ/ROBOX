...
def parse_args():
    ...
    parser.add_argument(
        "--download-dir",
        type=str,
        default=get_robox_path("datasets"),
    )
    parser.add_argument(
        "--datasets",
        type=str,
        choices=["all", "robox_goal", "robox_spatial", "robox_object", "robox_100"],
        default="all",
    )
    parser.add_argument(
        "--use-huggingface",
...
def main():
    ...
    # If not, download
    download_utils.robox_dataset_download(
    ...
    download_utils.check_robox_dataset(download_dir=args.download_dir)
