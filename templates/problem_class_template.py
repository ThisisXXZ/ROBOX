...
from robox.robox.envs.bddl_base_domain import BDDLBaseDomain, register_problem
from robox.robox.envs.robots import *
from robox.robox.envs.objects import *
from robox.robox.envs.predicates import *
from robox.robox.envs.regions import *
from robox.robox.envs.utils import rectangle2xyrange
...
class YOUR_CLASS_NAME(BDDLBaseDomain):
    def __init__(self, bddl_file_name, *args, **kwargs):
        ...
        if "scene_xml" not in kwargs or kwargs["scene_xml"] is None:
            kwargs.update(
                {"scene_xml": "scenes/robox_kitchen_tabletop_base_style.xml"}
            )
        if "scene_properties" not in kwargs or kwargs["scene_properties"] is None:
            # The scene properties need to be specified in robox/envs/arenas/style.py.
            kwargs.update(
                {
                    "scene_properties": {
