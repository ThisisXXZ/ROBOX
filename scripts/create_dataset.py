...
import init_path
import robox.robox.utils.utils as robox_utils
import cv2
from PIL import Image
from robosuite.utils import camera_utils

from robox.robox.envs import *
...
def main():
    ...
    hdf5_path = os.path.join(get_robox_path("datasets"), bddl_file_dir.split("bddl_files/")[-1].replace(".bddl", "_demo.hdf5"))
    ...
    for (i, ep) in enumerate(demos):
        ...
        model_xml = robox_utils.postprocess_model_xml(model_xml, {})
