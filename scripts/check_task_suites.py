...
import init_path
from robox.robox import benchmark, get_robox_path
...
def main():
    ...
    benchmark_root_path = get_robox_path("benchmark_root")
    init_states_default_path = get_robox_path("init_states")
    datasets_default_path = get_robox_path("datasets")
    bddl_files_default_path = get_robox_path("bddl_files")
