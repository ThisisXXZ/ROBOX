...
import robox.robox.envs.bddl_utils as BDDLUtils
from robox.robox.envs.robots import *
from robox.robox.envs.utils import *
from robox.robox.envs.object_states import *
from robox.robox.envs.objects import *
from robox.robox.envs.regions import *
from robox.robox.envs.arenas import *
...
class BDDLBaseDomain(SingleArmEnv):
    ...
    def __init__(
        ...
        arena_type="table",
        scene_xml="scenes/robox_base_style.xml",
        scene_properties={},
        **kwargs,
    ):
        t0 = time.time()
