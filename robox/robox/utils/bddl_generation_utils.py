...
@PDDLDefinition(problem_name="ROBOX_Tabletop_Manipulation")
@Language
...
@PDDLDefinition(problem_name="ROBOX_Kitchen_Tabletop_Manipulation")
@Language
...
@PDDLDefinition(problem_name="ROBOX_Floor_Manipulation")
@Language
...
@PDDLDefinition(problem_name="ROBOX_Coffee_Table_Manipulation")
@Language
...
@PDDLDefinition(problem_name="ROBOX_Study_Tabletop_Manipulation")
@Language
...
@PDDLDefinition(problem_name="ROBOX_Living_Room_Tabletop_Manipulation")
@Language
