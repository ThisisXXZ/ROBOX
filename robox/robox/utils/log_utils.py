...
class RoboxColorFormatter(logging.Formatter):
...
class RoboxDefaultLogger:
    def __init__(self, logger_config_path, project_name="robox"):
...
def get_project_logger(project_name="robox", logger_config_path=None):
