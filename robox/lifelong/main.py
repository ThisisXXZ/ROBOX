...
from robox.lifelong.algos import get_algo_class, get_algo_list
from robox.lifelong.models import get_policy_list
from robox.lifelong.datasets import GroupedTaskDataset, SequenceVLDataset, get_dataset
from robox.lifelong.metric import evaluate_loss, evaluate_success
...
def main(hydra_cfg):
    ...
    cfg.folder = cfg.folder or get_robox_path("datasets")
    cfg.bddl_folder = cfg.bddl_folder or get_robox_path("bddl_files")
    cfg.init_states_folder = cfg.init_states_folder or get_robox_path("init_states")
    ...
    if cfg.use_wandb:
        wandb.init(project="robox", config=cfg)
