...
from robox.robox.benchmark import get_benchmark
from robox.robox.envs import OffScreenRenderEnv, SubprocVectorEnv
from robox.robox.utils.time_utils import Timer
from robox.robox.utils.video_utils import VideoWriter
from robox.lifelong.algos import *
from robox.lifelong.datasets import get_dataset, SequenceVLDataset, GroupedTaskDataset
from robox.lifelong.metric import (
    evaluate_loss,
    evaluate_success,
    raw_obs_to_tensor_obs,
)
from robox.lifelong.utils import (
    control_seed,
    safe_device,
    torch_load_model,
    NpEncoder,
...
from robox.lifelong.main import get_task_embs
...
benchmark_map = {
    "robox_10": "ROBOX_10",
    "robox_spatial": "ROBOX_SPATIAL",
    "robox_object": "ROBOX_OBJECT",
    "robox_goal": "ROBOX_GOAL",
}
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["robox_10", "robox_spatial", "robox_object", "robox_goal"],
    )
...
def main():
    args = parse_args()
    # e.g., experiments/ROBOX_SPATIAL/Multitask/BCRNNPolicy_seed100/
    ...
    cfg.folder = get_robox_path("datasets")
    cfg.bddl_folder = get_robox_path("bddl_files")
    cfg.init_states_folder = get_robox_path("init_states")
